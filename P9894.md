...
题解链接: <https://www.luogu.com.cn/article/ehjv3cio>
...
于是算法大致完成。但一定要考虑到价格为 $0$ 的书的情况。在计算前 $m$ 本书的时候，定义双指针，如果 $m$ 本之后有价格为 $0$ 的书，则必须买，累计一下即可特别地，价格为 $0$ 的书数比 $m$ 大则输出 Richman；$m$ 比 $n$ 大就输出 Impossible。
